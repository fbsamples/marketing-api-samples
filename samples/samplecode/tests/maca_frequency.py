...
from samples.samplecode.maca_frequency import MacaFrequencySample


class MacaFrequencyTestCase(SampleTestCase):

    def setUp(self):
        super(MacaFrequencyTestCase, self).setUp()
        self.ca_sample = MacaFrequencySample()
    ...
    def tearDown(self):
        super(MacaFrequencyTestCase, self).tearDown()
