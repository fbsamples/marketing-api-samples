...
## Creating custom audiences based on mobile app events cumulative values

***

This sample shows how to use the Custom Audiences API to create a custom
audience based on mobile app events. You can create MACAs quite easily via the
native tools like ads manager or power editor, this sample will demonstrate how
to create ones based on the cumulative value of app events for example
cumulative purchase values, which is only possible through the API at the
moment.
